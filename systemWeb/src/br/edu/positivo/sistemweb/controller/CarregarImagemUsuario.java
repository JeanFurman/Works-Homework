 ...
 */
@WebServlet("/CarregarImagemUsuario")
public class CarregarImagemUsuario extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request !=null && request.getParameter("idUsuario") != null ){
			Integer idUsuario = Integer.valueOf(request.getParameter("idUsuario"));
			Usuario usuario = em.find(Usuario.class, idUsuario);
			String caminhoDaImagem = usuario.getCaminhoDaImagem();
